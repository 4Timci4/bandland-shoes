    ...
    <div className="admin-sidebar">
      ...
      <nav className="admin-sidebar__nav">
        <ul>
          ...
          <li
            className={`has-submenu ${isContactOpen || isActiveParent('/admin/contact') ? 'open' : ''}`}
          >
            ...
            <ul className="submenu">
              <li
                className={
                  isActive('/admin/contact-details') ? 'active-submenu' : ''
                }
              >
                <Link to="/admin/contact-details">
                  <FaWrench />
              ...
              <li
                className={
                  isActive('/admin/contact-submissions') ? 'active-submenu' : ''
                }
              >
